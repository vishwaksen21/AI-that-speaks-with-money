...
import { Loader2, Bot, Wand2, User } from 'lucide-react';
                ...
                {messages.length === 0 && (
                    <Card className="flex flex-col items-center justify-center text-center p-8">
                        ...
                        <CardDescription className="max-w-md mt-2">
                           Ask "what if" questions about your finances. For example: "What is the impact of a new car loan?" or "Project my net worth in 5 years."
                        </CardDescription>
                    </Card>
                )}
